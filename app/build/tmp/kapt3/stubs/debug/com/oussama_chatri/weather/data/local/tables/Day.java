...
public final class Day {
    ...
    com.oussama_chatri.weather.data.local.tables.Condition condition, double uv) {
        super();
    }
    ...
    @org.jetbrains.annotations.NotNull
    public final com.oussama_chatri.weather.data.local.tables.Condition component19() {
        return null;
    }
    ...
    @org.jetbrains.annotations.NotNull
    public final com.oussama_chatri.weather.data.local.tables.Day copy(double maxtemp_c, double maxtemp_f, double mintemp_c, double mintemp_f, double avgtemp_c, double avgtemp_f, double maxwind_mph, double maxwind_kph, double totalprecip_mm, double totalprecip_in, double totalsnow_cm, double avgvis_km, double avgvis_miles, int avghumidity, int daily_will_it_rain, int daily_chance_of_rain, int daily_will_it_snow, int daily_chance_of_snow, @org.jetbrains.annotations.NotNull
    com.oussama_chatri.weather.data.local.tables.Condition condition, double uv) {
        return null;
    }
