...
import com.oussama_chatri.weather.data.offline.tables.Astro
import com.oussama_chatri.weather.data.offline.tables.Condition
import com.oussama_chatri.weather.data.offline.tables.Current
import com.oussama_chatri.weather.data.offline.tables.Day
import com.oussama_chatri.weather.data.offline.tables.Forecast
import com.oussama_chatri.weather.data.offline.tables.ForecastDay
import com.oussama_chatri.weather.data.offline.tables.Hour
import com.oussama_chatri.weather.data.offline.tables.Location
import com.oussama_chatri.weather.data.offline.tables.WeatherData

fun apiToEntityWeatherData(apiWeatherData: com.oussama_chatri.weather.data.online.weatherApi.WeatherData): WeatherData {
    return WeatherData(
...
fun apiToEntityLocation(apiLocation: com.oussama_chatri.weather.data.online.weatherApi.Location): Location {
    return Location(
...
fun apiToEntityCurrent(apiCurrent: com.oussama_chatri.weather.data.online.weatherApi.Current): Current {
    return Current(
...
fun apiToEntityCondition(apiCondition: com.oussama_chatri.weather.data.online.weatherApi.Condition): Condition {
    return Condition(
...
fun apiToEntityForecast(apiForecast: com.oussama_chatri.weather.data.online.weatherApi.Forecast): Forecast {
    return Forecast(
        forecastday = apiToEntityForecastDayList(apiForecast.forecastday)
    )
}

fun apiToEntityForecastDayList(apiForecastDayList: List<com.oussama_chatri.weather.data.online.weatherApi.ForecastDay>): List<ForecastDay> {
    return apiForecastDayList.map { apiToEntityForecastDay(it) }
}

fun apiToEntityForecastDay(apiForecastDay: com.oussama_chatri.weather.data.online.weatherApi.ForecastDay): ForecastDay {
    return ForecastDay(
...
fun apiToEntityDay(apiDay: com.oussama_chatri.weather.data.online.weatherApi.Day): Day {
    return Day(
...
fun apiToEntityAstro(apiAstro: com.oussama_chatri.weather.data.online.weatherApi.Astro): Astro {
    return Astro(
...
fun apiToEntityHourList(apiHourList: List<com.oussama_chatri.weather.data.online.weatherApi.Hour>): List<Hour> {
    return apiHourList.map { apiToEntityHour(it) }
}

fun apiToEntityHour(apiHour: com.oussama_chatri.weather.data.online.weatherApi.Hour): Hour {
    return Hour(
